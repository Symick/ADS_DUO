...
//        assertTrue(freightTrain.toString().indexOf("from Amsterdam to Berlin") > 0); INCORRECT WRITTEN TEST?
    ...
    public void T14_findWagonOnTrainAtPosition() {
        ...
        // find by position
        assertEquals(8001, passengerTrain.findWagonAtPosition(0).getId(),"First wagon should be found");
        assertEquals(8002, passengerTrain.findWagonAtPosition(1).getId(),"Second wagon should be found");
        assertEquals(8007, passengerTrain.findWagonAtPosition(6).getId(),"Last wagon should be found");
        assertNull(passengerTrain.findWagonAtPosition(7),"No wagon should be found beyond last position");
        ...
        assertNull(passengerTrain.findWagonAtPosition(-1),"No wagon should be found before first position");
        assertNull(trainWithoutWagons.findWagonAtPosition(1),"No wagon should be found beyond last position");
        assertNull(trainWithoutWagons.findWagonAtPosition(0),"No wagon should be found beyond last position");
    ...
    public void T18_CanInsertAtFront() {
        ...
        assertSame(freightWagon2, freightTrain.findWagonAtPosition(1),
    ...
    public void T19_CanInsertAtAnyPosition() {
        ...
        assertEquals(8005, trainWithoutWagons.findWagonAtPosition(2).getId(),
                "insertAtPosition should disconnect and insert the given head wagon");
        ...
        assertFalse(trainWithoutWagons.insertAtPosition(1, passengerWagon8002),
    ...
    public void T20_ShouldSplitTrainCorrectly() {
        ...
        assertTrue(passengerTrain.splitAtPosition(3, trainWithoutWagons),
        ...
        assertFalse(passengerTrain.splitAtPosition(3, trainWithoutWagons),
        ...
        assertFalse(passengerTrain.splitAtPosition(0, trainWithoutWagons),
    ...
    public void T22_checkReverseTrain() {
        ...
        assertEquals(7, passengerTrain.getNumberOfWagons());
        assertEquals(8007, passengerTrain.findWagonAtPosition(0).getId());
        assertEquals(8006, passengerTrain.findWagonAtPosition(1).getId());
        assertEquals(8005, passengerTrain.findWagonAtPosition(2).getId());
        assertEquals(8001, passengerTrain.findWagonAtPosition(6).getId());
